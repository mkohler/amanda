...
#define SWIGTYPE_p_interface_t swig_types[6]
...
XS(_wrap_read_disklist_internal) {
  {
    ...
    if ((items < 7) || (items > 7)) {
      SWIG_croak("Usage: read_disklist_internal(filename,disks,diskclass,hosts,hostclass,ifaces,ifaceclass);");
    }
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "read_disklist_internal" "', argument " "3"" of type '" "char *""'");
    }
    arg3 = (char *)(buf3);
    {
    ...
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "read_disklist_internal" "', argument " "5"" of type '" "char *""'");
    }
    arg5 = (char *)(buf5);
    {
    ...
    if (!SWIG_IsOK(res7)) {
      SWIG_exception_fail(SWIG_ArgError(res7), "in method '" "read_disklist_internal" "', argument " "7"" of type '" "char *""'");
    }
    arg7 = (char *)(buf7);
    result = (cfgerr_level_t)read_disklist_internal(arg1,arg2,arg3,arg4,arg5,arg6,arg7);
    {
      SV *for_stack;
      SP += argvi; PUTBACK;
