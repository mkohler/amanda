...
XS(_wrap_delete_Header__SWIG_1) {
  {
    dumpfile_t *arg1 = (dumpfile_t *) 0 ;
    void *argp1 = 0 ;
    int res1 = 0 ;
...
XS(_wrap_delete_Header) {
  ...
  dispatch:
    switch(_index) {
    case 1:
      ++PL_markstack_ptr; SWIG_CALLXS(_wrap_delete_Header__SWIG_1); return;
    }
  }
  
  croak("No matching function for overloaded 'delete_Header'");
  XSRETURN(0);
}


XS(_wrap_C_from_string) {
  {
    char *arg1 = (char *) 0 ;
    int res1 ;
    char *buf1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: C_from_string(string);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "C_from_string" "', argument " "1"" of type '" "char const *""'");
    }
    arg1 = (char *)(buf1);
